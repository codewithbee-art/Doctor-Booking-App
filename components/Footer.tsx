        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h2 className="font-heading text-lg font-bold text-white">
              Dr. Bishnu Acharya Medical Practice
            </h2>
            <p className="mt-3 font-body text-base text-white/80">
              Professional healthcare with an advanced booking system for your
              convenience.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 space-y-2 font-body text-base text-white/80">
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
            <p className="font-body text-sm text-white/60">
              &copy; {new Date().getFullYear()} Dr. Bishnu Acharya Medical Practice. All
              rights reserved.
            </p>
