        ...
        {step === "success" && (
          <div className="rounded-2xl border border-accent/30 bg-white px-6 py-12 text-center shadow-sm md:px-12">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              {bookingId && (
                <a
                  href={`/receipt?type=booking&id=${bookingId}`}
                  className="flex items-center gap-2 rounded-lg bg-primary px-6 py-3 font-body text-base font-semibold text-white hover:bg-primary/90 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
